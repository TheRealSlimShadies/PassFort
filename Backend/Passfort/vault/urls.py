...
urlpatterns = [
    ...
    path('labels/<int:label_id>/update/', views.update_vault_label, name='update_vault_label'),
    ...
    path('labels/<str:label_name>/credentials/<int:credential_id>/update/', views.update_user_credential, name='update_user_credential'),
]
