...
export default { resetConfirm,resetEmailRequest,loginRequest,updateCredentials,registrationRequest,getLabels,getCredentials,createLabels,deleteLabels,deleteCredentials,createCredentials};